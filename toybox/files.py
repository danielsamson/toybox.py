...
class Files:
    ...
    def generateLuaIncludeFile(cls, dependencies: List[Dependency]):
        ...
        with open(os.path.join(Paths.toyboxesFolder(), 'toyboxes.lua'), 'w') as out_file:
            out_file.write('--\n')
            out_file.write('--  toyboxes.lua - include file auto-generated by toybox.py (https://github.com/danielsamson/toybox.py).\n')
            out_file.write('--\n')
            out_file.write('\n')
    ...
    def generateMakefile(cls, dependencies: List[Dependency]):
        ...
        with open(os.path.join(Paths.toyboxesFolder(), 'toyboxes.mk'), 'w') as out_file:
            out_file.write('#\n')
            out_file.write('#  toyboxes.mk - include file auto-generated by toybox.py (https://github.com/danielsamson/toybox.py).\n')
            out_file.write('#\n')
            out_file.write('\n')
    ...
    def generateIncludeFile(cls, dependencies: List[Dependency]):
        ...
        with open(os.path.join(Paths.toyboxesFolder(), 'toyboxes.h'), 'w') as out_file:
            out_file.write('//\n')
            out_file.write('//  toyboxes.h - include file auto-generated by toybox.py (https://github.com/danielsamson/toybox.py).\n')
            out_file.write('//\n')
            out_file.write('\n')
    ...
    def generateLuacheckFile(cls, dependencies: List[Dependency]):
        ...
        with open(os.path.join(Paths.toyboxesFolder(), 'luacheck.lua'), 'w') as out_file:
            out_file.write('--\n')
            out_file.write('--  Luacheck.lua - include file auto-generated by toybox.py (https://github.com/danielsamson/toybox.py).\n')
            out_file.write('--\n')
            out_file.write('\n')
    ...
    def generateReadMeFileIn(cls, folder: str):
        with open(os.path.join(folder, 'README.md'), 'w') as out_file:
            ...
            out_file.write('\n')
            out_file.write('This folder contains files auto-generated and managed by [**toybox.py**](https://github.com/danielsamson/toybox.py).\n')
            out_file.write('\n')
            out_file.write('**!!! DO NOT MODIFY OR PLACE ANYTHING IN THIS FOLDER !!!**\n')
            out_file.write('\n')
            out_file.write('Please [install](https://github.com/danielsamson/toybox.py#installation) **toybox.py** in order to modify or update the content of this folder.\n')
    ...
    def generateMakefileSetup(cls):
        ...
        with open(extension_main_file, 'w') as out_file:
            out_file.write('// -- This file was auto-generated by toybox.py (https://github.com/danielsamson/toybox.py).\n')
            out_file.write('\n')
